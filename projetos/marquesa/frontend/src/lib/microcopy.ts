...
// Cópia local em frontend/copy/microcopy.json — Vercel não enxerga ../../../copy
// (build context = frontend/). Source of truth fica em projetos/marquesa/copy/;
// sync via copy manual quando atualizar (TODO: pre-build script).
