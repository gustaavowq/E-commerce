// Bandeiras de pagamento como SVG inline. Sem dependencia de imagem externa.
...
function Card({ children, label }: { children: React.ReactNode; label: string }) {
  return (
    <div
      title={label}
      aria-label={label}
      className="flex h-7 w-11 items-center justify-center rounded-md border border-border bg-white px-1.5 shadow-sm"
    >
      {children}
    </div>
  )
  ...
  return (
    <Card label="Visa">
      <svg viewBox="0 0 64 22" className={className} xmlns="http://www.w3.org/2000/svg">
        <text x="32" y="17" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="900" fontStyle="italic" fontSize="20" fill="#1A1F71" letterSpacing="0.5">
          VISA
        </text>
      </svg>
    </Card>
  ...
  return (
    <Card label="Elo">
      <svg viewBox="0 0 40 22" className={className} xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="22" y="14" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="9" fill="#000">
          elo
        </text>
      </svg>
    </Card>
  ...
  return (
    <Card label="American Express">
      <svg viewBox="0 0 50 22" className={className} xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="25" y="14.5" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="9" fill="#FFF" letterSpacing="1">
          AMEX
        </text>
      </svg>
    </Card>
  ...
  return (
    <Card label="Boleto">
      <svg viewBox="0 0 40 22" className={className} xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="20" y="20" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="700" fontSize="4.5" fill="#1F2937">
          BOLETO
        </text>
      </svg>
    </Card>
