...
import { adminPersonasRouter } from './personas.js'
import { adminWaitlistRouter } from './waitlist.js'
...
adminRouter.use('/personas',  adminPersonasRouter)
adminRouter.use('/waitlist',  adminWaitlistRouter)
