...
function mockPix(orderNumber: string, amount: number): PixPaymentResult {
  ...
  const fakeKey = `00020126360014BR.GOV.BCB.PIX0114+5511999999999520400005303986540${amount.toFixed(2).length}${amount.toFixed(2)}5802BR5910KORE TECH 6009SAO PAULO62${orderNumber.length + 4}05${orderNumber}6304ABCD`
